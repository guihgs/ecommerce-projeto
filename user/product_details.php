...
if(isset($_COOKIE['item']))
	{
		...
		{	
			...
			$found=0;
		if($img1==$values11[0]) //this is for check cookies available or not if available then increase qty
		{
			...
			$res=mysqli_query($link, "SELECT * FROM product WHERE product_image='$img1'");
				...
				{ ?>
					<script type="text/javascript">
						alert("Esta quantidade não está disponivel");
					</script>
				<?php	
				}else{
		...
		<div class="header-bottom"><!--header-bottom-->
			<div class="container">
				<div class="row">
					...
					<div class="col-sm-3">
						<form action="pesquisar.php" method="POST" class="search_box pull-right">
						<input type="text" name="search" placeholder="Pesquisar">
						<button type="submit" name="submit-search">Ir</button>
						</form>
					</div>
				</div>
			</div>
						...
						<div class="col-sm-7">
							<div class="product-information"><!--/product-information-->
								...
								<span>
									...
									<button type="submit" class="btn btn-fefault cart" name="submit1">
